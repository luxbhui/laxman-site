    ...
    <main-section theme="sidebar-right">
      <template v-slot:default>
        <div class="content">
          <h3>Laxman Bhui</h3>
          <p>
            I have Bachelor Degree in Computer Science and Information
            Technology
          </p>

          <h3>My field of work</h3>
          <p>
            My field of work is hardware components. I have been working as
            maintainence worker since past 5 years.
          </p>
          <quote-card />
